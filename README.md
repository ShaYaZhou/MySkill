...
| Skill | Purpose |
| --- | --- |
| `video-transcript` | Create Markdown transcript documents from video or playlist URLs. It prefers human subtitles and can fall back to OpenAI or Kimi transcription. |
